# Shell functions. Sourced by zsh/zshrc.

# uq — remove the macOS quarantine xattr from a Homebrew-installed app/binary.
# Refuses to touch anything that didn't come from Homebrew.
uq() {
